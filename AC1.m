...
Tset = ([22.2,22.3,22.4,22.2,22.1,22.1,22.0,20.4,20.2,20.2,20.4,20.8,...
        20.5,20.3,20.6,20.4,20.8,20.9,20.9,21.3,21.6,21.5,22.2,22.5]-18)/7*4+18;
% 计算外壁的表面温度
...
%变频空调虚拟储能
for t=1:24
    Emax = R_in*c_in*(V1*8)*(Tmax-Tmin)/3600000; 
...
%虚拟储能容量
for t=1:24
    Esum(t) = R_in*c_in*(Tmax-Tset(t))*(V1*8); 
    a(t) = Esum(t)/3600000;
    Es(t) = R_in*c_in*(Tset(t)-Tmin)*(V1*8); 
    b(t) = Es(t)/3600000;
end
